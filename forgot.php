    ...
    <?php else :?>
        <script>
            window.onload = function() {
                ...
                if(flag == "1"){
                    errorElt.innerText = "Wrong Email Address or Full Name";
                }

                var submitElt = document.getElementById("submitt");
                submitElt.onclick = function() {
                    if (errorElt.innerText == "Wrong Email Address or Password") {
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        <div class="text-center">
                                            ...
                                            <p class="mb-4">We get it, stuff happens. Just enter details of your account and reset password!</p>
                                        </div>
                                        <form class="user" action="forgotcheck.php" method="post">
