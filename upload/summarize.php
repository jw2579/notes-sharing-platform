<?php
use Phpml\Summarization\TextRank;
            ...
            <div id="content">
                  ...
                  <script>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                ...
                                <script>
                                    ...
                                    if(<?php echo $user_name;?> == "Please login first"){
                      ...
                      <li class="nav-item dropdown no-arrow mx-1">
                          ...
                          <!-- Dropdown - Messages -->
                          <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    aria-labelledby="messagesDropdown" id = "dropDownMessages">
                                    <h6 class="dropdown-header">
                                        Message Center
                                    </h6>
                                    <a class="dropdown-item d-flex align-items-center" href="./summarize.php?center=manual.pdf">
                            ...
                            <script>
                                ...
                                if(<?php echo $user_name;?> == "Please login first"){
                                    document.getElementById("dropDownMessages").style.display = "none"; 
                                }                                
                                function toNone(){
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Upload and get summarization here</h1>
                    </div>
                    ...
                    <div class="col-xl-9 col-md-9 mb-4">
                        <?php if(isset($_FILES["file"]["name"])) :?>
                            <textarea class="form-control" id="deblock_udid" name="deblock_udid" rows="16" style="min-width: 90%"><?php $output = system("/home/stustudy/anaconda3/bin/python capturenew.py 2>&1"); ?></textarea>
                        <?php else :?>
