<?php
    ...
    $result = $conn->query("SELECT * FROM document WHERE `type` = 'Algorithms' ORDER BY weight DESC");
    ...
    $re_ud = $conn->query("SELECT * from (select name from document where type = 'Algorithms') d left JOIN (select dname from updown where uname = '$user_name') upd on d.name = upd.dname");
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="comp202.php">Algorithms</a>
                        <a class="collapse-item" href="comp284.php">Networks</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item dropdown no-arrow mx-1">
                          ...
                          <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="./comp202.php?center=manual.pdf">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Algorithms</h1>
                    </div>
                    ...
                    <div class="row" id = "main_list">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <h6>After learning this module, you can have an appreciation of the diversity of computational fields to which algorithmics has made significant contributions; have fluency in using basic data structures in conjunction with classical algorithmic problems; be familiar with formal theories providing evidence that many important computational problems are inherently intractable.</h6>                                    
                                </div>
                            </div>
    ...
    function addElement(){
        ...
        for (var i = 0; i < arr.length; i++){
            ...
            newCardDownload.onclick = function(){
                window.location = "./comp202.php?filename="+newCardDownload.id;
            }
