<?php
    ...
    $result = $conn->query("SELECT * FROM document WHERE `type` = 'Database' ORDER BY weight DESC");
    ...
    $re_ud = $conn->query("SELECT * from (select name from document where type = 'Database') d left JOIN (select dname from updown where uname = '$user_name') upd on d.name = upd.dname");
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="comp207.php">Database</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item dropdown no-arrow mx-1">
                          ...
                          <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="./comp207.php?center=manual.pdf">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id = "main_list">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <h6>After learning this module, you can identify and apply the principles underpinning transaction management within DBMS and the main security issues involved in securing transaction; demonstrate an understanding of advanced SQL topics; illustrate the issues related to Web technologies as a semi-structured data representation formalism. </h6>    
    ...
    function addElement(){
        ...
        for (var i = 0; i < arr.length; i++){
            ...
            newCardDownload.onclick = function(){
                window.location = "./comp207.php?filename="+newCardDownload.id;
            }
