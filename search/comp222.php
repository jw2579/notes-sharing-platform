<?php
    ...
    $result = $conn->query("SELECT * FROM document WHERE `type` = 'Game Theory' ORDER BY weight DESC");
    ...
    $re_ud = $conn->query("SELECT * from (select name from document where type = 'Game Theory') d left JOIN (select dname from updown where uname = '$user_name') upd on d.name = upd.dname");
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="comp222.php">Game Theory</a>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item dropdown no-arrow mx-1">
                          ...
                          <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="./comp222.php?center=manual.pdf">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Game Theory</h1>
                    </div>
    ...
    function addElement(){
        ...
        for (var i = 0; i < arr.length; i++){
            ...
            newCardDownload.onclick = function(){
                window.location = "./comp222.php?filename="+newCardDownload.id;
            }
