<?php
    ...
    $result = $conn->query("SELECT * FROM document WHERE `type` = 'Machine Learning' ORDER BY weight DESC ");
    ...
    $re_ud = $conn->query("SELECT * from (select name from document where type = 'Machine Learning') d left JOIN (select dname from updown where uname = '$user_name') upd on d.name = upd.dname");
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="comp219.php">Machine Learning</a>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item dropdown no-arrow mx-1">
                          ...
                          <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="./comp219.php?center=manual.pdf">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Machine Learning</h1>
                    </div>
                    ...
                    <div class="row" id = "main_list">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <h6>After learning this module, you can identify or describe the characteristics of intelligent agents and the environments that they can inhabit; identify, contrast and apply to simple examples the major search techniques that have been developed for problem-solving in AI; distinguish the characteristics, and advantages and disadvantages, of the major knowledge representation paradigms that have been used in AI, such as production rules, semantic networks, propositional logic and first-order logic.</h6> 
                                </div>
                            </div>
    ...
    function addElement(){
        ...
        for (var i = 0; i < arr.length; i++){
            ...
            newCardDownload.onclick = function(){
                window.location = "./comp219.php?filename="+newCardDownload.id;
            }
